...
export default function Form() {
  ...
  return (
    <form action={actionForm}  className='max-w-md mx-auto p-4 mt-6 flex flex-col justify-center items-center gap-3'>
        ...
        <div className="relative z-0 w-full mb-5 group">
            <textarea  name="message" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" required />

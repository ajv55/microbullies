...
export default function Form() {
  ...
  return (
    ...
    <div  className='w-full lg:mb-32 flex justify-evenly items-center'>
      <div style={{backgroundImage: 'linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url("https://hips.hearstapps.com/hmg-prod/images/group-portrait-of-adorable-puppies-royalty-free-image-1687451786.jpg")'}} className='w-[50%] drop-shadow-xl h-screen bg-cover bg-center'>

      </div>
        <form ref={ref} action={sendEmailAction}  className=' lg:w-[44%] lg:h-screen mx-auto p-4 lg:bg-slate-200 drop-shadow-xl rounded-xl flex flex-col justify-center items-center gap-3'>
          <h2 className={`${alegreya.className} text-6xl lg:text-7xl mb-10 `}>Contact Us</h2>
